...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        mounted () {
            this.axios.get(`https://www.vue-js.com/api/v1/messages?accesstoken=${bus.user.accesstoken}`).then((res) => {
                console.log(res)
        ...
        methods: {
            markread () {
                if (this.flag === 1) {
                    this.axios.post('https://www.vue-js.com/api/v1/message/mark_all', {accesstoken: bus.user.accesstoken}).then((res) => {
                        this.flag++
                    })
                }
            }
