<template>
    <div class="topics" :class="{noscroll: showMenu}">
        ...
        <div class="page">
            <ul>
                <li v-for="(topic, index) in topics" :key="index" class="topic">
...
export default {
    ...
    methods: {
        ...
        getTopics () {
            this.scroll = false
            this.axios.get(`https://www.vue-js.com/api/v1/topics?tab=${this.searchKey.tab}&page=${this.searchKey.page}&limit=${this.searchKey.limit}`).then((res) => {
